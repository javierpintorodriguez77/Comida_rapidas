    ...
    <div class="container q-mx-auto q-px-md q-mt-xl" style="max-width: 1400px;">
      ...
      <div class="q-mb-xl">
        ...
        <q-card class="tech-chef-card shadow-12 overflow-hidden border-amber">
          <div class="row no-wrap border-responsive items-stretch">
            <q-img :src="chefBebida.imagen" class="col-12 col-md-5" height="260px" fit="cover" />
            <q-card-section class="col-12 col-md-7 flex flex-center q-pa-lg bg-slate-800">
              <div class="full-width">
                <div class="row items-center justify-between q-mb-sm">
                  <div class="text-h5 text-weight-bolder text-white">{{ chefBebida.nombre }}</div>
                  <q-chip outline color="amber-5" text-color="amber-5" class="text-bold text-caption">
                    ESPECIALIDAD DE LA CASA
                  </q-chip>
                </div>
                <p class="text-body1 text-grey-4 q-mb-lg font-light">{{ chefBebida.descripcion }}</p>
                <div class="row items-center justify-between">
                  <span class="text-h4 text-weight-bolder text-accent">{{ chefBebida.precio }}</span>
                  <q-btn 
                    unelevated 
                    color="accent" 
                    icon="visibility" 
      ...
      <div class="row items-center justify-between q-mb-md">
        <div class="row items-center">
          <div class="tech-icon-box q-mr-sm">
            <q-icon name="local_bar" color="accent" size="20px" />
          </div>
